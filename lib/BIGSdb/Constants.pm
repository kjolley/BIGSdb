...
use constant COUNTRIES => {
	...
	q(Antigua & Barbuda)                            => { iso3 => q(ATG), continent => q(North America) },
	...
	q(Bosnia & Herzegovina)                         => { iso3 => q(BIH), continent => q(Europe) },
	...
	q(Saint Kitts & Nevis)                          => { iso3 => q(KNA), continent => q(North America) },
