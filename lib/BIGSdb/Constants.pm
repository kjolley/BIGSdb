...
use constant COUNTRIES => {
	...
	q(Eswatini)                          => { iso3 => q(SWZ), continent => q(Africa) },
	...
	q(Gambia)                            => { iso3 => q(GMB), continent => q(Africa) },
	...
	q(Netherlands)                       => { iso3 => q(NLD), continent => q(Europe) },
	...
	q(Timor-Leste)                                  => { iso3 => q(TLS), continent => q(Asia) },
