...
push @EXPORT_OK, qw(BUTTON_CLASS RESET_BUTTON_CLASS FACE_STYLE FLANKING MAX_ROWS);
$EXPORT_TAGS{'interface'} = [qw(BUTTON_CLASS RESET_BUTTON_CLASS FACE_STYLE FLANKING MAX_ROWS)];
