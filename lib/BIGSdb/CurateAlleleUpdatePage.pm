	...
	if ($exists) {
		if ($pending_count) {
			...
			$right_buffer .=
			  ...
			  . "designations will be demoted to pending designations.\">&nbsp;<i>i</i>&nbsp;</a>";
			$right_buffer .= "</h3>\n";
		...
		$right_buffer .=
		    " <a class=\"tooltip\" title=\"Pending designations - These are provisional designations that may have "
