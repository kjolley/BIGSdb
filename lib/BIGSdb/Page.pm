...
use constant SEQ_FLAGS   => ( 'ambiguous read', 'downstream fusion', 'frameshift', 'internal stop codon', 'no start codon', 'truncated', 'upstream fusion' );
...
sub get_stylesheet {
	...
	my $filename = 'bigsdb.css?v=20101120';
	if ( !$system->{'db'} ) {
		$stylesheet = "/$filename";
