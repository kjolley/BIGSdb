...
function load_pie(a,b,c){$("#bar_controls").css("display","none");$("#line_controls").css("display","none");$("#map_controls").css("display","none");$("#geography_controls").css("display","none");if("undefined"!=typeof b){var d=b.replace(/^.+\.\./,"");"loci"==get_field_type()&&void 0!=locus_labels[b]&&(d=locus_labels[b]);d=d.replace(/^s_\d+_/,"");var e=d3.format(".1f");d3.json(a).then(function(g){for(var h=pie_json_to_cols(g,c),f=pie_json_to_cols(g,50),m=0,k=0;k<f.columns.length;k++)"Others"==f.columns[k][0]&&
