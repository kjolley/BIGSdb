...
function load_pie(a,b,c){$("#bar_controls").css("display","none");$("#line_controls").css("display","none");$("#map_controls").css("display","none");$("#geography_controls").css("display","none");if("undefined"!=typeof b){var d=b.replace(/^.+\.\./,"");d=d.replace(/^s_\d+_/,"");var e=d3.format(".1f");d3.json(a).then(function(g){for(var h=pie_json_to_cols(g,c),f=pie_json_to_cols(g,50),m=0,k=0;k<f.columns.length;k++)"Others"==f.columns[k][0]&&(m=1);m||f.columns.push(["Others",0]);d+=" ("+h.count+" value"+
(1==h.count?"":"s")+")";var l=bb.generate({bindto:"#bb_chart",title:{text:d},data:{columns:f.columns,names:f.names,type:pie?"pie":"donut",order:null,colors:{Others:"#aaa"}},pie:{label:{show:!0},expand:!1},legend:{show:!0,position:"bottom"},size:{height:500},tooltip:{format:{value:function(a,b,c){return a+" ("+e(100*b)+"%)"}}}});l.unload();l.load({columns:h.columns});$("#segments").on("slidechange",function(){var a=$("#segments").slider("value");$("#segments_display").text(a);segments!=a&&set_prefs("segments",
a);segments=a;a=pie_json_to_cols(g,segments);l.unload();l.load({columns:a.columns})});c!=segments&&(h=pie_json_to_cols(g,segments),l.unload(),l.load({columns:h.columns}));$(".transform_to_donut").off("click").click(function(){$(".transform_to_donut").css("display","none");$(".transform_to_pie").css("display","inline");pie=0;set_prefs("pie",0);l.unload();load_pie(a,b,c)});$(".transform_to_pie").off("click").click(function(){$(".transform_to_pie").css("display","none");$(".transform_to_donut").css("display",
