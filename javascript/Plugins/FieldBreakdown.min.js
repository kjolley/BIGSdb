...
function pie_json_to_cols(a,b){var c=[],d=[],e=0,h=0,f=0;a.forEach(function(a){a.label=a.label.toString();""==a.label&&(a.label="No value");e++;e>=b?(h+=a.value,f++,e==b&&(d=[a.label,a.value])):c.push([a.label,a.value])});1==f?c.push(d):1<f&&c.push(["Others",h]);return{columns:c,count:e}}
