...
$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");var prefs_loaded,prefs_load_attempts=0,selected_field,selected_type,marker_colour,marker_size,geography_map;
...
function(){marker_size=$("#marker_size").slider("value");set_prefs("marker_size",marker_size);c.removeLayer(d);d=get_marker_layer(a);c.addLayer(d)}))});$("#marker_size").slider({min:0,max:10,value:marker_size});c.on("rendercomplete",function(a){htmlToImage.toPng(document.querySelector("canvas"),{filter:function(a){return a.className?-1===a.className.indexOf("ol-control"):!0}}).then(function(a){$("#export_map_image").off("click").click(function(){download(a,selected_field+"_map.png")})})})})}
