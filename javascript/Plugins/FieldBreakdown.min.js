...
h.removeLayer(e);e=get_marker_layer(a);h.addLayer(e)}),$("#marker_size").off("slidechange").on("slidechange",function(){marker_size=$("#marker_size").slider("value");set_prefs("marker_size",marker_size);h.removeLayer(e);e=get_marker_layer(a);h.addLayer(e)}))});$("#marker_size").slider({min:0,max:10,value:marker_size});3>mapping_option&&(g.setCollapsible("Map"==c?!1:!0),g.setCollapsed("Map"==c?!1:!0))})}
