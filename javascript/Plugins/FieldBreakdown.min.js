...
"Conic Equal Area":d3.geoConicEqualArea,Equirectangular:d3.geoEquirectangular,"Natural Earth":d3.geoNaturalEarth,Mercator:d3.geoMercator,Robinson:d3.geoRobinson,Stereographic:d3.geoStereographic,Times:d3.geoTimes,"Transverse Mercator":d3.geoTransverseMercator,"Winkel tripel":d3.geoWinkel3},m=g[theme];d3.json(a).then(function(k){"country"==b&&(k=merge_terms(k));var l=get_range(k),n=d3.geomap.choropleth().geofile(h).colors(m).column("value").format(d3.format(",d")).legend({width:50,height:120}).projection(f[projection]).duration(1E3).domain([0,
