...
function apply_select2(){window.jQuery&&$.fn.select2&&$("select:not(.locuslist):not(.widelist):not([multiple])").not(".select2-hidden-accessible").select2({minimumResultsForSearch:0,dropdownAutoWidth:!0,width:"resolve"})}
