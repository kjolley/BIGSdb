...
function apply_select2(){window.jQuery&&$.fn.select2&&$("select:not(.locuslist):not(.widelist):not(.filter):not([multiple])").not(".select2-hidden-accessible").each(function(){var a=$(this);a.is(":visible")||a.hasClass("do_not_calc_width")||a.css("width",calcSelectWidth(a)+"px");a.select2({minimumResultsForSearch:0,dropdownAutoWidth:!0})})}
