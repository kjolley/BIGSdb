...
a.key.length&&!a.ctrlKey&&!a.altKey&&!a.metaKey){var c=$(this).closest(".select2-container").prev("select");c.one("select2:open",function(){var b=document.querySelector(".select2-container--open .select2-search__field");b.value=a.key;$(b).trigger("input")});c.select2("open");a.preventDefault()}})});$.urlParam=function(a){a=(new RegExp("[?&]"+a+"=([^&#]*)")).exec(window.location.href);return null==a?null:a[1]||0};
function apply_select2(){window.jQuery&&$.fn.select2&&$("select:not(.locuslist):not(.widelist):not(.filter):not(.no_init_select2):not([multiple])").not(".select2-hidden-accessible").each(function(){var a=$(this),c=0<a.find('option[value=""]').length;a.is(":visible")||a.hasClass("do_not_calc_width")||a.css("width",calcSelectWidth(a)+"px");a.select2({minimumResultsForSearch:0,dropdownAutoWidth:!0,placeholder:c?"":void 0,allowClear:c})})}
