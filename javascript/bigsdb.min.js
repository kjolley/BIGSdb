...
function apply_select2(){window.jQuery&&$.fn.select2&&$("select:not(.locuslist):not(.widelist):not([multiple])").not(".select2-hidden-accessible").each(function(){var a=$(this);a.is(":visible")||a.css("width",calcSelectWidth(a)+"px");a.select2({minimumResultsForSearch:0,dropdownAutoWidth:!0})})}function measureTextWidth(a,c){var b=(measureTextWidth.canvas||(measureTextWidth.canvas=document.createElement("canvas"))).getContext("2d");b.font=c;return b.measureText(a).width}
