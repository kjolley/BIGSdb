...
function changeElementAttribute(a,b,c,d){elements[b][c]!==d&&("specific_values"===c&&(console.log(d),d=d.includes("\n")?d.split("\n"):d.split()),d=clean_value(d),elements[b][c]=d,$.post(url,{db:instance,page:"dashboard",updatePrefs:1,attribute:"elements",value:JSON.stringify(elements)},function(){reloadElement(a,b)}))}function applyFormatting(){fitty(".dashboard_big_number",{maxSize:64})}
