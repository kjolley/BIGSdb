...
return b}function getDataExplorerParams(a){var b={page:"explorer"};b.db=instance;b.field=elements[a].field;b.include_old_versions=$("#include_old_versions").prop("checked");b.record_age=$("#record_age_slider").slider("value");null!=elements[a].specific_values&&(b.specific_values=elements[a].specific_values);return b}function updateDashboardName(a){$("#loaded_dashboard").val(a);$("#loaded_dashboard").prop("disabled",!1);$("#delete_dashboard").css("display","inline")}
