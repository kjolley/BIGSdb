...
function changeElementAttribute(a,b,c,d){elements[b][c]!==d&&("specific_values"!==c||Array.isArray(d)||(d=d.includes("\n")?d.split("\n"):d.split()),d=clean_value(d),elements[b][c]=d,saveAndReloadElement(a,b))}function applyFormatting(){fitty(".dashboard_big_number",{maxSize:64});$(".item-content div.subtitle a").tooltip()}function getNextid(){return 0===Object.keys(elements).length?1:Math.max.apply(Math,[].concat($jscomp.arrayFromIterable(Object.keys(elements))))+1}
...
"inline"),"gauge"===b?($("li#watermark_control,li#text_colour_control,li#background_colour_control").css("display","none"),$("li.gauge_colour").css("display","block")):"number"===b&&($("li#watermark_control,li#text_colour_control,li#background_colour_control").css("display","block"),$("li.gauge_colour").css("display","none")))}
function check_and_show_visualisation(a,b){var c=$("input[name='"+b+"_visualisation_type']:checked").val();$("#"+b+"_breakdown_display").val();var d=$("#"+b+"_specific_value_display").val(),e=$("#"+b+"_specific_values").val();"specific values"===c&&("0"!=d&&0!=e.length?(elements[b].display="field",elements[b].url=url+"&page=query",elements[b].url_text="Query records",elements[b].post_data={db:instance,page:"query",attribute:elements[b].field,list:Array.isArray(e)?e.join("\n"):e},saveAndReloadElement(a,
