...
url})});$(window).resize(function(){showOrHideElements();setGridMargins(d);loadNewElements()});$("a#expand_trigger").click(function(a){setTimeout(function(){setGridMargins(d);d.refreshItems().layout()},250)});setGridMargins(d);window.dispatchEvent(new Event("resize"))});
