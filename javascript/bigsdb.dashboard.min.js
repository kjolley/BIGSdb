...
getNextid();addElement(c,a)});$("div#dashboard").on("click touchstart",".dashboard_edit_element",function(){var a=$(this).attr("data-id");editElement(c,a)});$("div#dashboard").on("click touchstart",".dashboard_remove_element",function(){var a=$(this).attr("data-id");removeElement(c,a)});$("div#dashboard").on("click touchstart",".setup_element",function(){var a=$(this).attr("data-id");editElement(c,a)});$("div#dashboard").on("click touchstart",".dashboard_explore_element",function(){var a=$(this).attr("data-id");
...
($("#"+b).slideDown(),$("#"+a).html('<span class="fas fa-minus"></span>')):($("#"+b).slideUp(),$("#"+a).html('<span class="fas fa-plus"></span>'))});$("a#dashboard_toggle").on("click",function(){$.get(url+"&page=dashboard&updatePrefs=1&attribute=default&value=0",function(){window.location=url})});$(window).resize(function(){setElementWidths();showOrHideElements();loadNewElements()})});
function setElementWidths(){var a=$("div#dashboard").width(),b=(a-10)%150/10;$("div.dashboard_element_width1").css("width",150+b);$("div.dashboard_element_width2").css("width",304+2*b);$("div.dashboard_element_width3").css("width",458+3*b);$("div.dashboard_element_width4").css("width",612+4*b);448>a&&$("div.dashboard_element_width2").css("width",458)}
