...
function setGridMargins(a){var b=155*Math.floor($("div#dashboard_panel").width()/155);console.log(b);$("div#dashboard").css("width",b);a.on("layoutEnd",function(){a.off("layoutEnd");var c=0;a.getItems().forEach(function(a){a=a.getPosition().left+a.getWidth();c=Math.max(c,a)});300>c&&(c=300);c>b?$("div#dashboard").css("width",b):$("div#dashboard").css("width",c);console.log($("div#dashboard").width())})}
