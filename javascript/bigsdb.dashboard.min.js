...
b)});$("div.modal").on("change","#"+b+"_breakdown_display,#"+b+"_specific_value_display,#"+b+"_specific_values,#"+b+"_bar_colour_type",function(){show_or_hide_control_elements(a,b);check_and_show_visualisation(a,b)});$("div.modal").on($.modal.AFTER_CLOSE,function(a,b){$("div.modal").remove()})})}
function show_or_hide_control_elements(a,b){a=$("input[name='"+b+"_visualisation_type']:checked").val();var c=$("#"+b+"_specific_value_display").val(),d=$("#"+b+"_breakdown_display").val();$("li#value_selector").css("display","breakdown"===a?"none":"block");$("li#breakdown_display_selector").css("display","breakdown"===a?"block":"none");$("li#specific_value_display_selector").css("display","breakdown"===a?"none":"block");"specific values"===a?($("fieldset#change_duration_control").css("display","number"===
c?"inline":"none"),$("fieldset#design_control").css("display","inline"),$("li#top_value_selector").css("display","none"),"gauge"===c?($("li#watermark_control,li#text_colour_control,li#background_colour_control").css("display","none"),$("li.gauge_colour").css("display","block")):"number"===c&&($("li#watermark_control,li#text_colour_control,li#background_colour_control").css("display","block"),$("li.gauge_colour").css("display","none"))):"breakdown"===a&&("bar"===d?($("fieldset#design_control,li.bar_colour_type").css("display",
"inline"),$("li#watermark_control,li#text_colour_control,li#background_colour_control,li#top_value_selector").css("display","none"),b=$("input[name='"+b+"_bar_colour_type']:checked").val(),$("li.chart_colour").css("display","continuous"===b?"block":"none")):"cumulative"===d?($("fieldset#design_control,li.chart_colour").css("display","inline"),$("li#watermark_control,li#text_colour_control,li#background_colour_control,li.bar_colour_type,li#top_value_selector").css("display","none")):"top"===d?$("li#top_value_selector").css("display",
"inline"):$("fieldset#design_control,li#top_value_selector").css("display","none"))}
