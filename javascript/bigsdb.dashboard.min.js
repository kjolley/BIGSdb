...
function post(a,b){var c=$("<form></form>");$.each(b,function(a,b){var d=$("<input></input>");d.attr("type","hidden");d.attr("name",a);d.attr("value",b);c.append(d)});c.attr("method","post");c.attr("action",a);c.attr("target",$("#open_new").prop("checked")?"_blank":null);$(document.body).append(c);c.submit()}function clean_value(a){if(null!=a)return Array.isArray(a)?(a=a.map(function(a){return a.trim()}),a=a.filter(function(a){return null!=a&&""!=a})):a=a.trim(),a}
