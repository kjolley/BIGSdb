...
function resetDefaults(){$("#modify_dashboard_panel").toggle("slide",{direction:"right"},"fast");$.get(url+"&resetDefaults=1",function(){location.reload()})}
function resetSeqbinRange(a){delete elements[a].min;delete elements[a].max;saveAndReloadElement(null,a);$.ajax({url:url+"&seqbin_range=1",type:"GET",success:function(a){a=JSON.parse(a).range;$("#seqbin_range_slider").slider("option","values",[a.min,a.max]);$("#seqbin_min").html(a.min);$("#seqbin_max").html(a.max);$("#reset_seqbin_range").css("display","none")}})}function createNew(){$.ajax({url:url+"&newDashboard=1&type="+dashboard_type,type:"GET",success:function(){location.reload()}})}
