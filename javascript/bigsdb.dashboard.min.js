...
"inline"),"gauge"===b?($("li#watermark_control,li#text_colour_control,li#background_colour_control").css("display","none"),$("li.gauge_colour").css("display","block")):"number"===b&&($("li#watermark_control,li#background_colour_control").css("display","block"),$("li.gauge_colour").css("display","none")))}
