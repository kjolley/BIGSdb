...
{direction:"right"},"fast",function(){$("#modify_dashboard_panel").is(":visible")?$("#modal_overlay").addClass("open"):$("#modal_overlay").removeClass("open")});$("#dashboard_panel_trigger").show();return!1});$("#dashboard_panel_trigger").show();$(document).mouseup(function(a){var c=$("#modify_dashboard_panel");c.is(a.target)||0!==c.has(a.target).length||(c.hide(),$("#modal_overlay").removeClass("open"))});$("#fill_gaps").change(function(){a=$("#fill_gaps").prop("checked");try{d._settings.layout.fillGaps=
