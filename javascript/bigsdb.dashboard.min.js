...
b,"display","setup"))}function reloadElement(a){var b=url+"&page=dashboard&element="+a;null!=qryFile&&qryFile.length&&(b+="&qry_file="+qryFile);null!=listFile&&listFile.length&&null!=attribute&&attribute.length&&(b+="&list_file="+listFile+"&attribute="+attribute);$.get(b,function(b){try{$("div#element_"+a+"> .item-content > .ajax_content").html(JSON.parse(b).html),elements[a]=JSON.parse(b).element,applyFormatting()}catch(d){console.log(d.message)}})}
