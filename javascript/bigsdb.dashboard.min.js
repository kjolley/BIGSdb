...
function editElement(a,b,c){$("span#control_"+b).hide();$("span#wait_"+b).show();$.get(url+"&page=dashboard&control="+b,function(c){$(c).appendTo("body").modal();$("#edit_elements").prop("checked")&&$("span#control_"+b).show();$("span#wait_"+b).hide();$("div.modal").on("change","#"+b+"_visualisation_type",function(){$("li#value_selector").css("display","breakdown"===$("#"+b+"_visualisation_type:checked").val()?"none":"block");$("li#breakdown_display_selector").css("display","breakdown"===$("#"+b+
"_visualisation_type:checked").val()?"block":"none");$("li#specific_value_display_selector").css("display","breakdown"===$("#"+b+"_visualisation_type:checked").val()?"none":"block");check_and_show_visualisation(a,b)});$("div.modal").on("change","#"+b+"_breakdown_display,#"+b+"_specific_value_display,#"+b+"_specific_values",function(){check_and_show_visualisation(a,b)});$("div.modal").on($.modal.AFTER_CLOSE,function(a,b){$("div.modal").remove()})})}
function check_and_show_visualisation(a,b){$("#"+b+"_visualisation_type:checked").val();$("#"+b+"_breakdown_display").val();$("#"+b+"_specific_value_display").val();$("#"+b+"_specific_value").val()}function reloadElement(a,b){$.get(url+"&page=dashboard&element="+b,function(a){try{$("div#element_"+b+"> .item-content > .ajax_content").html(JSON.parse(a).html),elements[b]=JSON.parse(a).element,applyFormatting()}catch(d){console.log(d.message)}})}
