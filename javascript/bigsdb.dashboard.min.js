...
function showOrHideElements(){var a=$("div#dashboard").width()<MOBILE_WIDTH;$("div.hide_mobile").css("display",a?"none":"block");$("div.hide_border").css("border",a?"0":"1px solid #ccc");$.each(elements,function(a,c){"setup"==c.display&&$("div#element_"+c.id+" div.item-content").css("display","block")})}
