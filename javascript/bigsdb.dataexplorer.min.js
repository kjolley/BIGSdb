...
$("div#data_explorer").on("click touchstart","#analyse",function(){canAnalyse()&&runAnalysis()})});function canAnalyse(){var a=!1;$(".option_check").each(function(b,c){!0===this.checked&&(a=!0)});var b=!1;$(".field_selector").each(function(a,c){""!==this.value&&(b=!0)});return a&&b}
function runAnalysis(){var a=[];$(".option_check").each(function(b,c){!0===this.checked&&(b=this.id,b=b.replace("v",""),a.push(dataIndex[b]))});console.log("Values: "+a);var b=[field];$(".field_selector").each(function(a,c){""!==this.value&&b.push(this.value)});console.log("Fields: "+b)}
...
$(this).html().replace(",","");c+=parseInt(a,10)||0});$("span#total_records").html(commify(c));dataIndex=JSON.parse(a).index})}function commify(a){return a.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")};
