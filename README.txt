...
v1.53.0: *Added settings to enforce password length and inclusion of special
         ...
         *Support for API keys as an alternative to OAuth authentication.
...
v1.51.7: *Option to include third-party analysis fields in dashboards.
         ...
         *LIN code prefix nicknames exposed in API.
         *Isolate sender now used as sender for new profiles generated by
          define_profiles.pl script.
